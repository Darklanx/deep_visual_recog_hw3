...
Original file is located at
    https://colab.research.google.com/drive/1Eb2YD8Z4fmX6v853OJes3KG3wYk9wnL5
"""
...
class TrainingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i, ann in enumerate(anns):
            ...
            # gt['box']
            # gt['category'] = self.coco.cats[ann['category_id']]['name']
...
data_loader_test = torch.utils.data.DataLoader(
        testing_dataset, batch_size=1, shuffle=False, num_workers=4,
